...
# Calculate the precession matrix. Based on the article New precession expressions, 
# valid for long time intervals, 2011

precession_matrix <- function(jd_tdb)
{
  ...
  v <- cross(equator_pole, ecliptic_pole)
  normal_vec <- v/Norm(v)
  a <- cross(equator_pole, normal_vec)
